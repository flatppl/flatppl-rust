module {
  func.func @sample(%key: tensor<2xui64>) -> (tensor<f32>, tensor<2xui64>) {
    ...
    %84, %85 = stablehlo.rng_bit_generator %72, algorithm =  THREE_FRY : (tensor<2xui64>) -> (tensor<2xui64>, tensor<ui32>)
    %86 = stablehlo.constant dense<9> : tensor<ui32>
    %87 = stablehlo.shift_right_logical %85, %86 : tensor<ui32>
    %88 = stablehlo.convert %87 : (tensor<ui32>) -> tensor<f32>
    %89 = stablehlo.constant dense<1.1920929E-7> : tensor<f32>
    %90 = stablehlo.multiply %88, %89 : tensor<f32>
    %91 = stablehlo.constant dense<2.0> : tensor<f32>
    %92 = stablehlo.constant dense<1.0> : tensor<f32>
    %93 = stablehlo.multiply %90, %91 : tensor<f32>
    %94 = stablehlo.subtract %93, %92 : tensor<f32>
    %95 = chlo.erf_inv %94 : tensor<f32> -> tensor<f32>
    %96 = stablehlo.constant dense<1.4142135> : tensor<f32>
    %97 = stablehlo.multiply %95, %96 : tensor<f32>
    %98 = stablehlo.divide %83, %0 : tensor<f32>
    %99 = stablehlo.sqrt %98 : tensor<f32>
    %100 = stablehlo.divide %97, %99 : tensor<f32>
    return %100, %84 : tensor<f32>, tensor<2xui64>
  }
}
