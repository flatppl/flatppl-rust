module {
  func.func @sample() -> tensor<f32> {
    ...
    %62 = stablehlo.constant dense<0.0> : tensor<f32>
    %63 = stablehlo.constant dense<1.0> : tensor<f32>
    %64 = stablehlo.constant dense<> : tensor<0xi64>
    %65 = stablehlo.rng %62, %63, %64, distribution = NORMAL : (tensor<f32>, tensor<f32>, tensor<0xi64>) -> tensor<f32>
    %66 = stablehlo.divide %61, %0 : tensor<f32>
    %67 = stablehlo.sqrt %66 : tensor<f32>
    %68 = stablehlo.divide %65, %67 : tensor<f32>
    return %68 : tensor<f32>
  }
}
