module {
  func.func @logdensity(%arg0: tensor<i32>, %arg1: tensor<i32>, %arg2: tensor<f32>) -> tensor<f32> {
    ...
    %7 = stablehlo.compare EQ, %4, %5 : (tensor<f32>, tensor<f32>) -> tensor<i1>
    %8 = stablehlo.xor %6, %7 : tensor<i1>
    %9 = stablehlo.and %3, %8 : tensor<i1>
    %10 = stablehlo.constant dense<10.0> : tensor<f32>
    %11 = stablehlo.constant dense<20.0> : tensor<f32>
    %12 = stablehlo.select %9, %10, %11 : (tensor<i1>, tensor<f32>, tensor<f32>) -> tensor<f32>
