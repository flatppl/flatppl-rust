module {
  func.func @logdensity(%arg0: tensor<0xf32>, %arg1: tensor<0xi1>) -> (tensor<f32>, tensor<0xf32>, tensor<i1>, tensor<i1>, tensor<0xf32>) {
    ...
    return %0, %arg0, %2, %4, %arg0 : tensor<f32>, tensor<0xf32>, tensor<i1>, tensor<i1>, tensor<0xf32>
  }
}
