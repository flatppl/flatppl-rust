module {
  func.func @sample(%key: tensor<2xui64>) -> (tensor<f32>, tensor<2xui64>) {
    ...
    %4 = stablehlo.compare LT, %3, %1 : (tensor<f32>, tensor<f32>) -> tensor<i1>
    %5 = stablehlo.constant dense<1.5> : tensor<f32>
    %6 = stablehlo.select %4, %5, %3 : (tensor<i1>, tensor<f32>, tensor<f32>) -> tensor<f32>
    ...
    %12 = stablehlo.divide %1, %11 : tensor<f32>
    ...
    %39:3 = stablehlo.while(%36 = %34, %37 = %35, %38 = %0) : tensor<i32>, tensor<i1>, tensor<f32>
    cond {
      ...
      %49 = stablehlo.add %1, %48 : tensor<f32>
      ...
      %64 = stablehlo.compare GT, %51, %0 : (tensor<f32>, tensor<f32>) -> tensor<i1>
    ...
    %75 = stablehlo.power %74, %2 : tensor<f32>
    %76 = stablehlo.select %4, %75, %1 : (tensor<i1>, tensor<f32>, tensor<f32>) -> tensor<f32>
    %77 = stablehlo.multiply %39#2, %76 : tensor<f32>
    %78 = stablehlo.divide %77, %1 : tensor<f32>
    %79 = stablehlo.power %78, %3 : tensor<f32>
    ...
    %87 = stablehlo.subtract %86, %3 : tensor<f32>
    ...
    %92 = stablehlo.multiply %91, %79 : tensor<f32>
    %93 = stablehlo.add %0, %92 : tensor<f32>
    return %93, %80 : tensor<f32>, tensor<2xui64>
  }
}
